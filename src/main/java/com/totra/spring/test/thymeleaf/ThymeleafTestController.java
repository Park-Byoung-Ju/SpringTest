package com.totra.spring.test.thymeleaf;
...
import com.totra.spring.test.thymeleaf.domain.Member;
...
public class ThymeleafTestController {
	...
	@RequestMapping("/test02/musiclist")
	public String musiclist(Model model) {
		...
		return "thymleaf/musicList";
	}
	
	@RequestMapping("/test02/membership")
